...
-A local copy of the **[editor-architectural](https://github.com/Unity-Billal-mesloub/editor-architectural)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).Open-source 3D architectural editor with a local CLI, MCP tools, and practical workflows for humans and AI agents by the developer of, and distributes, `editor-architectural.DockerInWSL`
-A local copy of the **[Shapefile-Viewer-Editor-for-Agronomy](https://github.com/Unity-Billal-mesloub/Shapefile-Viewer-Editor-for-Agronomy)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).A Python and PyQt-based open-source application for agronomists and researchers to edit, visualize, and manage agricultural shapefiles with real-world map overlays and intuitive GUI controls by the developer of, and distributes, `Shapefile-Viewer-Editor-for-Agronomy.DockerInWSL`
-A local copy of the **[AgriBooksPublishing](https://github.com/Unity-Billal-mesloub/AgriBooksPublishing)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).The AGRI-Book Publishing is a web portal for an agriculture publication house. The system is used to fulfil the whole publishing process and bookseller can contact with the publisher. The main objective for making this project is for the publisher to take control over the publishing procedure. The publisher has full access over the users of the sys by the developer of, and distributes, `AgriBooksPublishing.DockerInWSL`
-A local copy of the **[trajectory_editor](https://github.com/Unity-Billal-mesloub/trajectory_editor)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).Extensible web-based editor for JSON Agri Format mission files, with plugin-based authentication and cloud storage support by the developer of, and distributes, `trajectory_editor.DockerInWSL`
-A local copy of the **[docs-editor](https://github.com/Unity-Billal-mesloub/docs-editor)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).Docs is an open-source text editor: web-native, made for real-time collaboration, cleanly structured documents and sub-documents with full ownership of your data. Built to scale with Django and React by the developer of, and distributes, `docs-editor.DockerInWSL`
-A local copy of the **[doc-GPT-Editor](https://github.com/Unity-Billal-mesloub/doc-GPT-Editor)** public Documention repository by [Unity-Billal-mesloub](https://github.com/Unity-Billal-mesloub).ChatGPT directly within Google Docs as an Editor Add-on by the developer of, and distributes, `doc-GPT-Editor.DockerInWSL`
...
```bash
git clone https://github.com/Unity-Billal-mesloub/editor-architectural.git
cd editor
bun install
bun dev
```
...
New node kinds and sidebar panels can ship as a plugin instead of editing the built-ins. Read [Create a plugin](https://editor.pascal.app/docs/developers/plugins) for the contract, and clone [`Unity-Agriculture/plugin-trees`](https://github.com/Unity-Agriculture/plugin-trees) as a worked example.
...
Use the [Bug Report](https://github.com/Unity-Billal-mesloub/editor-architectural/issues/new?template=bug_report.yml) template. Include steps to reproduce — this helps us fix things faster.

## Suggesting features

Use the [Feature Request](https://github.com/Unity-Billal-mesloub/editor-architectural/issues/new?template=feature_request.yml) template, or start a [Discussion](https://github.com/Unity-Billal-mesloub/editor-architectural/discussions) if you want to brainstorm first.

## Questions?

Head to [Discussions](https://github.com/Unity-Billal-mesloub/editor-architectural/discussions) — we're happy to help!
