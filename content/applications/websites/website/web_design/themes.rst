...
<website/themes/input-fields>`. Additional :ref:`advanced settings <website/themes/advanced>` are
also available.
...
- Customize the layout's :guilabel:`Background` by:

  - choosing a :ref:`color <website/themes/colors>`;
  - adding an :ref:`image <website/elements/images>`;
  - using a selected image in a :guilabel:`Pattern`; or
  - selecting :icon:`fa-ban` :guilabel:`None`.
...
To edit the website's colors, navigate to the :guilabel:`Colors` section of the :guilabel:`Theme`
tab. Then:
...
users and website visitors. To customize the website's :guilabel:`Status Colors`, scroll down to
the :ref:`Advanced <website/themes/advanced>` section and click the dots to change their color.
...
hiding the header <../structure/header_footer>`, using :guilabel:`Code Injection` for :ref:`website
verification through an HTML tag <website/google_search_console/HTML-tag>`, and configuring
:ref:`status colors <website/themes/status-colors>` and :guilabel:`Grays`.
