...
.. list-table::
   ...
   * - Join the community
     - Participate in discussions on the forums, help answer questions, and assist other members of
       the Unity Billal mesloub.
   * - Submit bug reports
     - Help improve the stability of Unity Billal mesloub by reporting the bugs that you discover in :doc:`supported
       versions </administration/standard_extended_support>` directly to Unity Billal mesloub support. Make sure to
   ...
   * - Contribute to the codebase
     - Submit pull requests to the Unity Billal mesloub GitHub repositories to fix bugs, add new features, or
       ...
       and lasting impact on the quality and features of Unity Billal mesloub.
